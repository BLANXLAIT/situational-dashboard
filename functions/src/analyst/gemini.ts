...
export const ANALYST_CONFIG = {
    ...
    systemPrompt: `You are the S.A.A.M. (Strategic Autonomous Analysis Module) Intelligence Analyst.
...
export async function generateNarrative(apiKey: string, context: any) {
    ...
    const model = genAI.getGenerativeModel({
        ...
        systemInstruction: ANALYST_CONFIG.systemPrompt,
        generationConfig: {
            temperature: ANALYST_CONFIG.temperature,
            topP: ANALYST_CONFIG.topP,
            topK: ANALYST_CONFIG.topK,
        },
    });
